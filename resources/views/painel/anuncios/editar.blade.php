...
@section('content')
    <div class="mt-3 mt-md-5 mb-5">
        <div class="row">
            <div class="col-12">
                <h1 class="h3 fw-bold">Editar Anúncio</h1>
            </div>
            <!-- Editar Anúncio -->
            <div class="col-12">
                        ...
                        <form action="{{ route('anuncios.update', $anuncio->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('titulo') is-invalid @enderror"
                                            id="titulo" name="titulo" placeholder="Título"
                                            value="{{ old('titulo', $anuncio->titulo) }}" required>
                                ...
                                @php
                                    ...
                                    $img1 = isset($imgs[0]) ? $imgs[0] : null;
                                    $img2 = isset($imgs[1]) ? $imgs[1] : null;
                                    $img3 = isset($imgs[2]) ? $imgs[2] : null;
                                    $img4 = isset($imgs[3]) ? $imgs[3] : null;
                                    $img5 = isset($imgs[4]) ? $imgs[4] : null;
                                @endphp
                                <h2 class="h5 mb-2 mt-2 mb-2">Imagens do anúncio, no mínimo 2 com o tamanho de no máximo 2mb
                                    cada
                                </h2>
                                <div class="col-12 col-lg-12 mb-3 d-flex gap-3">
                                    <div class="">
                                        <img src="{{ asset($img1) }}" alt="" width="110" class="rounded">
                                    </div>
                                    <div class="">
                                        <label for="img1" class="form-label">Img1</label>
                                        <input type="file"
                                            class="form-control input-custom @error('img1') is-invalid @enderror"
                                            name="img1" id="img1" accept="image/*">
                                        @error('img1')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-lg-12 mb-3 d-flex gap-3">
                                    <div class="">
                                        <img src="{{ asset($img2) }}" alt="" width="110" class="rounded">
                                    </div>
                                    <div class="">
                                        <label for="img2" class="form-label">Img2</label>
                                        <input type="file"
                                            class="form-control input-custom @error('img2') is-invalid @enderror"
                                            name="img2" id="img2" accept="image/*">
                                        @error('img2')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-lg-12 mb-3 d-flex gap-3">
                                    @if ($img3)
                                        <div class="">
                                            <img src="{{ asset($img3) }}" alt="" width="110" class="rounded">
                                        </div>
                                    @endif
                                    <div class="">
                                        <label for="img3" class="form-label">Img3</label>
                                        <input type="file"
                                            class="form-control input-custom @error('img3') is-invalid @enderror"
                                            name="img3" id="img3" accept="image/*">
                                        @error('img3')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-lg-12 mb-3 d-flex gap-3">
                                    @if ($img4)
                                        <div class="">
                                            <img src="{{ asset($img4) }}" alt="" width="110" class="rounded">
                                        </div>
                                    @endif
                                    <div class="">
                                        <label for="img4" class="form-label">Img4</label>
                                        <input type="file"
                                            class="form-control input-custom @error('img4') is-invalid @enderror"
                                            name="img4" id="img4" accept="image/*">
                                        @error('img4')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-12 col-lg-12 mb-3 pb-3 d-flex gap-3">
                                    @if ($img5)
                                        <div class="">
                                            <img src="{{ asset($img5) }}" alt="" width="110" class="rounded">
                                        </div>
                                    @endif
                                    <div class="">
                                        <label for="img5" class="form-label">Img5</label>
                                        <input type="file"
                                            class="form-control input-custom @error('img5') is-invalid @enderror"
                                            name="img5" id="img5" accept="image/*">
                                        @error('img5')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="" style="min-width: 150px; ">
                                        <div class="dropdown">
                                            <button
                                                ...
                                                aria-haspopup="true" aria-expanded="false" style="overflow: hidden">

                                                <div class="">
                                                    <i class="fa-solid fa-location-dot fa-sm "></i>
                                                    <span id="text-localidade">
                                                        @if (old('estado', $anuncio->estado) && old('cidade', $anuncio->cidade))
                                                            {{ old('estado', $anuncio->estado) }},
                                                            {{ old('cidade', $anuncio->cidade) }}
                                                        @else
                                                            Brasil
                                                        @endif
                                                    </span>
                                                ...
                                                <div class="px-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select shadow-none" name="estado"
                                                            ...
                                                            <option value="AC"
                                                                @if (old('estado', $anuncio->estado) == 'AC') selected @endif>Acre
                                                            </option>
                                                            <option value="AL"
                                                                @if (old('estado', $anuncio->estado) == 'AL') selected @endif>Alagoas
                                                            </option>
                                                            <option value="AP"
                                                                @if (old('estado', $anuncio->estado) == 'AP') selected @endif>Amapá
                                                            </option>
                                                            <option value="AM"
                                                                @if (old('estado', $anuncio->estado) == 'AM') selected @endif>Amazonas
                                                            </option>
                                                            <option value="BA"
                                                                @if (old('estado', $anuncio->estado) == 'BA') selected @endif>Bahia
                                                            </option>
                                                            <option value="CE"
                                                                @if (old('estado', $anuncio->estado) == 'CE') selected @endif>Ceará
                                                            </option>
                                                            <option value="DF"
                                                                @if (old('estado', $anuncio->estado) == 'DF') selected @endif>Distrito
                                                                Federal</option>
                                                            <option value="ES"
                                                                @if (old('estado', $anuncio->estado) == 'ES') selected @endif>Espírito
                                                                Santo</option>
                                                            <option value="GO"
                                                                @if (old('estado', $anuncio->estado) == 'GO') selected @endif>Goiás
                                                            </option>
                                                            <option value="MA"
                                                                @if (old('estado', $anuncio->estado) == 'MA') selected @endif>Maranhão
                                                            </option>
                                                            <option value="MT"
                                                                @if (old('estado', $anuncio->estado) == 'MT') selected @endif>Mato
                                                                Grosso</option>
                                                            <option value="MS"
                                                                @if (old('estado', $anuncio->estado) == 'MS') selected @endif>Mato
                                                                Grosso do Sul</option>
                                                            <option value="MG"
                                                                @if (old('estado', $anuncio->estado) == 'MG') selected @endif>Minas
                                                                Gerais</option>
                                                            <option value="PA"
                                                                @if (old('estado', $anuncio->estado) == 'PA') selected @endif>Pará
                                                            </option>
                                                            <option value="PB"
                                                                @if (old('estado', $anuncio->estado) == 'PB') selected @endif>Paraíba
                                                            </option>
                                                            <option value="PR"
                                                                @if (old('estado', $anuncio->estado) == 'PR') selected @endif>Paraná
                                                            </option>
                                                            <option value="PE"
                                                                @if (old('estado', $anuncio->estado) == 'PE') selected @endif>
                                                                Pernambuco</option>
                                                            <option value="PI"
                                                                @if (old('estado', $anuncio->estado) == 'PI') selected @endif>Piauí
                                                            </option>
                                                            <option value="RJ"
                                                                @if (old('estado', $anuncio->estado) == 'RJ') selected @endif>Rio de
                                                                Janeiro</option>
                                                            <option value="RN"
                                                                @if (old('estado', $anuncio->estado) == 'RN') selected @endif>Rio
                                                                Grande do Norte</option>
                                                            <option value="RS"
                                                                @if (old('estado', $anuncio->estado) == 'RS') selected @endif>Rio
                                                                Grande do Sul</option>
                                                            <option value="RO"
                                                                @if (old('estado', $anuncio->estado) == 'RO') selected @endif>Rondônia
                                                            </option>
                                                            <option value="RR"
                                                                @if (old('estado', $anuncio->estado) == 'RR') selected @endif>Roraima
                                                            </option>
                                                            <option value="SC"
                                                                @if (old('estado', $anuncio->estado) == 'SC') selected @endif>Santa
                                                                Catarina</option>
                                                            <option value="SP"
                                                                @if (old('estado', $anuncio->estado) == 'SP') selected @endif>São
                                                                Paulo</option>
                                                            <option value="SE"
                                                                @if (old('estado', $anuncio->estado) == 'SE') selected @endif>Sergipe
                                                            </option>
                                                            <option value="TO"
                                                                @if (old('estado', $anuncio->estado) == 'TO') selected @endif>
                                                                Tocantins
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select shadow-none" name="cidade"
                                                            id="cidade"
                                                            @if (!old('cidade', $anuncio->cidade)) disabled @endif>
                                                            <option value="" selected>Selecioner uma cidade</option>
                                                            @if (old('cidade', $anuncio->cidade))
                                                                <option value="{{ old('cidade', $anuncio->cidade) }}"
                                                                    selected>
                                                                    {{ old('cidade', $anuncio->cidade) }}</option>
                                                            @endif
                                                        </select>
                                                    </div>
                                ...
                                <div class="col-12 mx-auto mb-4">
                                    <div class="fw-semi-bold-1 mb-2">
                                        ...
                                        <input type="text" name="local_lat_lng" id="local_lat_lng"
                                            ...
                                            value="{{ old('local_lat_lng', $anuncio->local_lat_lng) }}" required>
                                        @error('local_lat_lng')
                                            <div class="invalid-feedback small fw-bold"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control input-custom  @error('descricao_local') is-invalid @enderror" id="descricao_local"
                                            name="descricao_local" placeholder="Descrição do Local" rows="8" required>{{ old('descricao_local', $anuncio->descricao_local) }}</textarea>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control input-custom  @error('descricao_servico') is-invalid @enderror" id="descricao_servico"
                                            name="descricao_servico" placeholder="Descrição do Serviço" rows="8" required>{{ old('descricao_servico', $anuncio->descricao_servico) }}</textarea>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('preco') is-invalid @enderror"
                                            ...
                                            value="{{ old('preco', $anuncio->preco) }}" required>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-floating mb-3">
                                        <input type="text"
                                            ...
                                            value="{{ old('tempo_resposta', $anuncio->tempo_resposta) }}" required>
                                        ...
                                        <select class="form-select @error('categoria_id') is-invalid @enderror"
                                            ...
                                            @foreach ($categorias as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (old('categoria_id', $anuncio->categoria_id) == $item->id) selected @endif>
                                                    {{ $item->nome }}
                                                </option>
                                            @endforeach
                                        </select>
...
@section('scripts')
    ...
    <script>
        var lat_long_padrao = JSON.parse(`{!! old('local_lat_lng', $anuncio->local_lat_lng) !!}`)
